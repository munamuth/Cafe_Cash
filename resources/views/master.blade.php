        ...
        <nav class="bg-dark nav_top">
            <div class="container">
                ...
                <ul class="social_link nav justify-content-center">
                    <li class="fb"><a class="" href="{{ url("https://fb.com/excelpolitan") }}" target="blank"><i class="fa fa-facebook"></i></a></li>
        ...
        <nav class="bg-light">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-sm-2">
                        <div>
                            <img src="/photo/logo/logo.png" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-sm-8">
                    </div>
        ...
        <nav class="bg-dark">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-4">
                        <ul class="nav justify-content-center">
                            <li class="nav-item"><a class="nav-link" href="#">Excelpolitan University ©2018</a></li>
                        </ul>
                    </div>
                    <div class="col-12 col-sm-4">
                        <ul class="nav justify-content-center">
